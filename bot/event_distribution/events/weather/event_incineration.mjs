...
export async function eventFunction (event) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setAuthor({"name": "Solar Eclipse",
            "iconUrl": "https://www.blaseball.wiki/images/thumb/5/51/Tgb_eclipse.png/60px-Tgb_eclipse.png",
            "url": "https://www.blaseball.wiki/w/Solar_Eclipse"})
